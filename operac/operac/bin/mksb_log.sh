...
logimpr1=${WORK}/logs/$(cat ${CONFIG}|sed -e '/^#/d'|sed -e '/^$/d'|grep MKSYSB|awk '{print $2}'|sed -e "s/#/*/")
...
logimpr=${WORK}/logs/$(cat ${CONFIG}|sed -e '/^#/d'|sed -e '/^$/d'|grep MKSYSB|awk '{print $2}'|sed -e "s/#/$dia1/")
